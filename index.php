...
<body>
    ...
    <div class="insertPhotoForm">
        <form action="core/handleForms.php" method="POST" enctype="multipart/form-data">
            <p>
                <br><br><br><br><label for="#">Description</label>
                <input type="text" name="photoDescription" placeholder="Describe your photo...">
            </p>
            <p>
    ...
    <div class="albumForm">
        <form action="core/handleForms.php" method="POST">
            <p>
                ...
                <input type="text" name="albumName" placeholder="Describe your album...">
